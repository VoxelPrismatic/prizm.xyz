...
> > The graph command now supports both-axis graphing [x^2+y^2=4, etc]
...
> Updated the graph command so you can now graph on the y axis too [x=y^2, y=x^2]
